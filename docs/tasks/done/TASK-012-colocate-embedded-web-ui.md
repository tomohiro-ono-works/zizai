...
- `Read Scope`: WP-1 Read Scope、`README.md`、`docs/handoffs/v23-migration-verification-contract.md`、`docs/tasks/active/TASK-016-adopt-approved-frontend-libraries.md`、TASK-012関連`tests/`。
- `Edit Scope`: `static/`、`apps/gui/`、`apps/common/contracts/web-frame/`、`zizai.py`、必要な場合だけ`apps/desktop/host.py`、`README.md`、`docs/features/{architecture,coding-rules,frontend}.md`、`docs/handoffs/v23-migration-verification-contract.md`、`docs/tasks/active/TASK-016-adopt-approved-frontend-libraries.md`、TASK-012関連`tests/{static,integration,e2e,unit,playwright,fixtures}/`と`tests/run-verification.ps1`。2026-08-25に旧Frontend root参照が判明した`tests/unit/test_bridge_contract.py`を明示追加した。
